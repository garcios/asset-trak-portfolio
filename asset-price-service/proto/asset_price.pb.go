...
type GetAssetPricesByDateRangeRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	AssetId       string                 `protobuf:"bytes,1,opt,name=asset_id,json=assetId,proto3" json:"asset_id,omitempty"`       // Identifier of the asset
...
func (x *GetAssetPricesByDateRangeRequest) Reset() {
	*x = GetAssetPricesByDateRangeRequest{}
	mi := &file_proto_asset_price_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetAssetPricesByDateRangeRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetAssetPricesByDateRangeRequest) ProtoMessage() {}

func (x *GetAssetPricesByDateRangeRequest) ProtoReflect() protoreflect.Message {
	mi := &file_proto_asset_price_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetAssetPricesByDateRangeRequest.ProtoReflect.Descriptor instead.
func (*GetAssetPricesByDateRangeRequest) Descriptor() ([]byte, []int) {
	return file_proto_asset_price_proto_rawDescGZIP(), []int{2}
}

func (x *GetAssetPricesByDateRangeRequest) GetAssetId() string {
	if x != nil {
		return x.AssetId
	}
	return ""
...
func (x *GetAssetPricesByDateRangeRequest) GetStartDate() string {
	if x != nil {
		return x.StartDate
	}
	return ""
...
func (x *GetAssetPricesByDateRangeRequest) GetEndDate() string {
	if x != nil {
		return x.EndDate
	}
	return ""
...
type GetAssetPricesByDateRangeResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	AssetId       string                 `protobuf:"bytes,1,opt,name=asset_id,json=assetId,proto3" json:"asset_id,omitempty"` // Identifier of the asset
...
func (x *GetAssetPricesByDateRangeResponse) Reset() {
	*x = GetAssetPricesByDateRangeResponse{}
	mi := &file_proto_asset_price_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetAssetPricesByDateRangeResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetAssetPricesByDateRangeResponse) ProtoMessage() {}

func (x *GetAssetPricesByDateRangeResponse) ProtoReflect() protoreflect.Message {
	mi := &file_proto_asset_price_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetAssetPricesByDateRangeResponse.ProtoReflect.Descriptor instead.
func (*GetAssetPricesByDateRangeResponse) Descriptor() ([]byte, []int) {
	return file_proto_asset_price_proto_rawDescGZIP(), []int{3}
}

func (x *GetAssetPricesByDateRangeResponse) GetAssetId() string {
	if x != nil {
		return x.AssetId
	}
	return ""
...
func (x *GetAssetPricesByDateRangeResponse) GetPrices() []*AssetPriceEntry {
	if x != nil {
		return x.Prices
	}
	return nil
...
var file_proto_asset_price_proto_rawDesc = []byte{
	...
	0x52, 0x09, 0x74, 0x72, 0x61, 0x64, 0x65, 0x44, 0x61, 0x74, 0x65, 0x22, 0x64, 0x0a, 0x15, 0x47,
	0x65, 0x74, 0x41, 0x73, 0x73, 0x65, 0x74, 0x50, 0x72, 0x69, 0x63, 0x65, 0x52, 0x65, 0x73, 0x70,
	...
	0x79, 0x22, 0x77, 0x0a, 0x20, 0x47, 0x65, 0x74, 0x41, 0x73, 0x73, 0x65, 0x74, 0x50, 0x72, 0x69,
	0x63, 0x65, 0x73, 0x42, 0x79, 0x44, 0x61, 0x74, 0x65, 0x52, 0x61, 0x6e, 0x67, 0x65, 0x52, 0x65,
	...
	0x09, 0x52, 0x07, 0x65, 0x6e, 0x64, 0x44, 0x61, 0x74, 0x65, 0x22, 0x68, 0x0a, 0x21, 0x47, 0x65,
	0x74, 0x41, 0x73, 0x73, 0x65, 0x74, 0x50, 0x72, 0x69, 0x63, 0x65, 0x73, 0x42, 0x79, 0x44, 0x61,
	...
	0x09, 0x52, 0x07, 0x61, 0x73, 0x73, 0x65, 0x74, 0x49, 0x64, 0x12, 0x28, 0x0a, 0x06, 0x70, 0x72,
	0x69, 0x63, 0x65, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x41, 0x73, 0x73,
	0x65, 0x74, 0x50, 0x72, 0x69, 0x63, 0x65, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x06, 0x70, 0x72,
	0x69, 0x63, 0x65, 0x73, 0x22, 0x57, 0x0a, 0x0f, 0x41, 0x73, 0x73, 0x65, 0x74, 0x50, 0x72, 0x69,
	0x63, 0x65, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x12, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x65, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x64, 0x61, 0x74, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x70,
	...
	,
...
var file_proto_asset_price_proto_goTypes = []any{
	...
	(*GetAssetPricesByDateRangeRequest)(nil),  // 2: GetAssetPricesByDateRangeRequest
	(*GetAssetPricesByDateRangeResponse)(nil), // 3: GetAssetPricesByDateRangeResponse
	(*AssetPriceEntry)(nil),                   // 4: AssetPriceEntry
}
var file_proto_asset_price_proto_depIdxs = []int32{
	4, // 0: GetAssetPricesByDateRangeResponse.prices:type_name -> AssetPriceEntry
	0, // 1: AssetPrice.GetAssetPrice:input_type -> GetAssetPriceRequest
	2, // 2: AssetPrice.GetAssetPricesByDateRange:input_type -> GetAssetPricesByDateRangeRequest
	1, // 3: AssetPrice.GetAssetPrice:output_type -> GetAssetPriceResponse
	3, // 4: AssetPrice.GetAssetPricesByDateRange:output_type -> GetAssetPricesByDateRangeResponse
